...
def knn_classifier(X_train, X_test, y_train, y_test):
    ...
    accuracy = st.write("Accuracy Score",accuracy_score(y_test, y_pred_one))
    recall = st.write("Recall",recall_score(y_test, y_pred_one, average='weighted'))
    f1 = st.write("F1_Score:",f1_score(y_test, y_pred_one, average=None))
    precision = st.write("Precision",precision_score(y_test, y_pred_one, average='micro'))
